...
tab_info = """
⬅️ Будь ласка, завантажте дані у бічній панелі, в форматі CSV або оберіть шаблон.
\nЗавантажте новий CSV-файл з офіційного порталу Держстату 🔗 [stat.gov.ua](https://stat.gov.ua/uk/explorer)
"""
